...
cmd({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://files.catbox.moe/ccxpv1.jpg", {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "NINJA-MD 🥀",
            body: config.DESCRIPTION || "𝐍𝐈𝐍𝐉𝐀_𝐇𝐀𝐂𝐊𝐄𝐑 🤌🥂",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/ccxpv1.jpg", // Static image URL
